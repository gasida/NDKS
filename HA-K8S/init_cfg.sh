...
# local dns setting
echo "192.168.100.10 k8s-m0" >> /etc/hosts
for (( m=1; m<=$1; m++ )); do echo "192.168.100.1$m k8s-m$m" >> /etc/hosts; done
for (( n=1; n<=$2; n++ )); do echo "192.168.100.10$n k8s-w$n" >> /etc/hosts; done
