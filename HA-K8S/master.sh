...
kubeadm init --apiserver-advertise-address=$MYIP --control-plane-endpoint "192.168.100.100:16443" --pod-network-cidr=172.16.0.0/16 --upload-certs --token-ttl 0 --token 123456.1234567890123456 --certificate-key=1234567890123456789012345678901234567890123456789012345678901234
